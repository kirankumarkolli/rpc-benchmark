// BasicHttp2Server.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    WCHAR url[] = L"http://localhost:9091/http2server/";
...
CleanUp:
    ...
    //
    // Call HttpRemoveUrl for added URLs.
    //
    HttpRemoveUrl(
        hReqQueue,     // Req Queue
        url        // Fully qualified URL
